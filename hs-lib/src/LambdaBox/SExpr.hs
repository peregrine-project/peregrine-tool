...
lBoxModuleToSexp target p =
  decodeString $ Serialize0.string_of_PAst $ LambdaBox.LBoxConvert.lBoxModuleConv target p

configToSexp :: LambdaBox.Config.Config -> String
configToSexp c =
  decodeString $ Serialize0.string_of_config $ LambdaBox.ConfigConvert.configConv c

backendConfigToSexp :: LambdaBox.Config.BackendConfig -> String
backendConfigToSexp c =
  decodeString $ Serialize0.string_of_backend_config $ LambdaBox.ConfigConvert.backendConfigConv c

erasurePhasesToSexp :: LambdaBox.Config.ErasurePhases -> String
erasurePhasesToSexp c =
  decodeString $ Serialize0.string_of_erasure_phases $ LambdaBox.ConfigConvert.erasurePhasesConv c

attributesConfigToSexp :: LambdaBox.Config.AttributesConfig -> String
attributesConfigToSexp c =
  decodeString $ Serialize0.string_of_attributes_config $ LambdaBox.ConfigConvert.attributesConfigConv c
